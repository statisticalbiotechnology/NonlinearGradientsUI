...
public class MS1DistributionPanel extends javax.swing.JPanel implements RTPanel {
    ...
    public MS1DistributionPanel() {
        ...
        mzmlTextField.getDocument().addDocumentListener(new TextFieldListener(this));
    ...
    private void initComponents() {
        ...
        mzmlTextField.setText("/Users/luminitamoruz/work/projects/gradient_design/NonlinearGradientsUI/data/ms1/20130604_OT-XL_U3000-BETA_500ng_Hela_01_centroided.mzML");
        ...
        minAbsIntTextField.setText("100000");
    ...
    private String getMzmlFileName() throws ValidationException {
        String text = this.mzmlTextField.getText();
    ...
    public List<Float> getRT() throws ValidationException {
        ...
        try {
            ...
            System.out.println("Intensity threshold: " + intensityThreshold);
            System.out.println("Min mz: " + this.minMz);
            System.out.println("Max mz: " + this.maxMz);

            /* Get a swing worker to do the .mzml manipulation in background */
            System.out.println(mzml + ", " + intensityThreshold + "," + this.absMinIntensity);
            final MzmlWorker mzmlWorker = new MzmlWorker(mzml, intensityThreshold, 
